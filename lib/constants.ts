...
export const navLinksBlogVietNam = [
  {
    id: 1,
    name: "Trang chủ",
    href: "/#home",
...
export const trustedVietNam = {
  title: "Được Tin cậy bởi Nhiều Nhà cung cấp Dịch vụ Du lịch",
};
  ...
  attractions: [
    {
      ...
      details: {
        ...
        description: [
          ...
          "Ngoài vẻ đẹp cảnh quan, Eo Gió còn nổi tiếng với những trải nghiệm độc đáo như ngắm bình minh và hoàng hôn tuyệt đẹp, tham gia các hoạt động chụp ảnh, và thưởng thức hải sản tươi ngon tại các nhà hàng địa phương.",

          "Du khách có thể kết hợp thăm quan Eo Gió với các điểm đến lân cận như bãi biển Kỳ Co, đảo Hòn Khô để có một hành trình trọn vẹn khám phá vẻ đẹp của vùng biển Quy Nhơn.",
        ],
      },
    },
    {
      ...
      image: "/ky-co.jpg",
      details: {
        title: "Khám phá Thiên đường Biển Kỳ Co: Viên ngọc Quý của Quy Nhơn",
        description: [
          "Kỳ Co, nằm ở phía đông Quy Nhơn, là một bãi biển hoang sơ với vẻ đẹp nguyên sơ. Nơi đây nổi tiếng với bãi cát trắng mịn, nước biển trong xanh và những vách đá độc đáo tạo nên khung cảnh tuyệt đẹp.",

          "Đối với những người yêu thích hoạt động, Kỳ Co mang đến nhiều trải nghiệm thú vị như tắm biển, lặn ngắm san hô, chèo thuyền kayak và khám phá các hang động tự nhiên. Nước biển trong vắt và êm ả tạo điều kiện lý tưởng cho các hoạt động dưới nước.",

          "Kỳ Co còn nổi tiếng với ẩm thực biển phong phú, nơi du khách có thể thưởng thức các món hải sản tươi ngon được đánh bắt trực tiếp từ ngư dân địa phương.",
        ],
      },
    },
    {
      ...
      image: "/hon-kho.jpg",
      details: {
        title: "Khám phá Vẻ đẹp Hoang sơ của Hòn Khô",
        description: [
          "Hòn Khô, một hòn đảo nhỏ nằm cách bờ biển Quy Nhơn không xa, là điểm đến lý tưởng cho những ai yêu thích khám phá thiên nhiên. Đảo nổi tiếng với bãi đá độc đáo, rạn san hô đẹp và làn nước trong xanh.",

          "Ngoài tắm biển, du khách có thể tham gia các hoạt động như lặn ngắm san hô, câu cá cùng ngư dân và thưởng thức hải sản tươi sống. Đặc biệt, Hòn Khô còn là điểm ngắm hoàng hôn tuyệt đẹp.",

          "Với không gian yên bình và thiên nhiên nguyên sơ, Hòn Khô mang đến trải nghiệm độc đáo cho du khách muốn tránh xa sự ồn ào của thành phố.",
        ],
      },
    },
    {
      ...
      details: {
        ...
        description: [
          ...
          "Khu vực này còn gắn liền với thi sĩ Hàn Mặc Tử, với khu lưu niệm và mộ phần của ông. Du khách có thể tham quan bảo tàng, thưởng thức thơ ca và chiêm ngưỡng cảnh quan đã truyền cảm hứng cho nhiều tác phẩm nghệ thuật.",

          "Ghềnh Ráng cũng là điểm lý tưởng để ngắm bình minh và hoàng hôn, với những góc nhìn ngoạn mục ra biển và thành phố Quy Nhơn.",
        ],
      },
    },
  ],
  ...
  attractions: [
    {
      ...
      details: {
        ...
        description: [
          ...
          "Beyond its scenic beauty, Eo Gio is famous for unique experiences such as watching beautiful sunrises and sunsets, participating in photography activities, and enjoying fresh seafood at local restaurants.",

          "Visitors can combine Eo Gio with nearby destinations like Ky Co beach and Hon Kho island for a complete journey exploring the beauty of Quy Nhon sea.",
        ],
      },
    },
    {
      ...
      image: "/ky-co.jpg",
      details: {
        title: "Exploring the Beach Paradise of Ky Co: Quy Nhon's Precious Gem",
        description: [
          "Ky Co, located in eastern Quy Nhon, is a pristine beach with untouched beauty. The place is famous for its fine white sand, clear blue water and unique rock formations creating a beautiful landscape.",

          "For activity lovers, Ky Co offers many interesting experiences such as swimming, snorkeling, kayaking and exploring natural caves. The clear and calm water provides ideal conditions for water activities.",

          "Ky Co is also famous for its rich seafood cuisine, where visitors can enjoy fresh seafood caught directly by local fishermen.",
        ],
      },
    },
    {
      ...
      image: "/hon-kho.jpg",
      details: {
        title: "Exploring the Pristine Beauty of Hon Kho",
        description: [
          "Hon Kho, a small island not far from Quy Nhon coast, is an ideal destination for nature lovers. The island is famous for its unique rocky beach, beautiful coral reefs and clear water.",

          "Besides swimming, visitors can participate in activities such as snorkeling, fishing with fishermen and enjoying fresh seafood. Especially, Hon Kho is also a beautiful sunset viewing spot.",

          "With peaceful space and pristine nature, Hon Kho offers a unique experience for visitors wanting to escape the city noise.",
        ],
      },
    },
    {
      ...
      details: {
        ...
        description: [
          ...
          "This area is also associated with poet Han Mac Tu, with his memorial area and tomb. Visitors can visit the museum, enjoy poetry and admire the landscape that has inspired many artworks.",

          "Ghenh Rang is also an ideal spot for watching sunrise and sunset, with spectacular views of the sea and Quy Nhon city.",
        ],
      },
    },
  ],
